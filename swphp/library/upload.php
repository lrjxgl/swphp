...
class upload{
	...
	public $sysallowtype=array('gif','jpg','bmp','png','jpeg','txt','mpeg',"mp4","ogg",'avi','rm','rmvb','wmv','flv',"webm",'mp3','wav','wma','swf','doc','pdf','zip','tar','svg');
	//系统默认允许上传
	//上传文件夹
	public $uploaddir="document_root/attach/";
